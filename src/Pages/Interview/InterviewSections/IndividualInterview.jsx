...
That's what I've learned through my work at SharApu.`}
                    </p>
                </div>
                ...
                <div className="bg-gray-50 p-6 rounded-xl">
                    ...
                    <div className="space-y-2 text-gray-600">
                        ...
                        <p>Support email: <a href="mailto:contact@shufuly.my" className="text-pink-500 hover:text-pink-600">contact@sharapu.my</a></p>
