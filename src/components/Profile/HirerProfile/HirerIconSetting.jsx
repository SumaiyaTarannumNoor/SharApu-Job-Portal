          ...
          <div className="max-w-3xl">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-6">
                  <div className="relative">
                    {previewUrl ? (
                      ...
                      <div className="w-32 h-32 rounded-full bg-pink-100 flex items-center justify-center border-4 border-pink-200">
                ...
                <div 
                  className="border-2 border-dashed border-pink-200 rounded-lg p-8 text-center hover:border-pink-400 transition-colors cursor-pointer relative"
